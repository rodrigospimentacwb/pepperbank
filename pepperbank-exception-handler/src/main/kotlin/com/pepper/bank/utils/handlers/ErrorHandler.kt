...
class ErrorHandler {
    ...
    companion object{
        ...
        fun buildReponse(servletRequest:HttpServletRequest,
                         error:String,
                         message:String,
                         status:HttpStatus): ResponseEntity<ErrorMessage>{
            return ResponseEntity(ErrorMessage(LocalDateTime.now(),
                status.value(),
                error,
                message,
                servletRequest.servletPath,
                servletRequest.method), status)
        }
    }
    ...
    fun geralExceptionHandler(request:HttpServletRequest,
        ...
        return when (ex) {
            ...
            is HttpRequestMethodNotSupportedException -> return httpRequestMethodNotSupportedExceptionHandler(request,response,ex)
    ...
    fun jsonParseExceptionHandler(servletRequest:HttpServletRequest,
                                  ...
                                  ex: JsonParseException):ResponseEntity<ErrorMessage>{
    ...
    fun internalServerErrorExceptionHandler(servletRequest:HttpServletRequest,
                                            servletResponse: HttpServletResponse,
                                            ex: HttpServerErrorException):ResponseEntity<ErrorMessage>{
        return buildReponse(servletRequest,
            ex.javaClass.simpleName,
    ...
    fun runtimeExceptionHandler(servletRequest:HttpServletRequest,
                                servletResponse: HttpServletResponse,
                                ex: RuntimeException):ResponseEntity<ErrorMessage>{
        return buildReponse(servletRequest,
            ex.javaClass.simpleName,
            ex.message ?: "Internal error server",
            HttpStatus.INTERNAL_SERVER_ERROR)
    ...
    fun httpRequestMethodNotSupportedExceptionHandler(servletRequest:HttpServletRequest,
                                                      servletResponse: HttpServletResponse,
                                                      ex: HttpRequestMethodNotSupportedException):ResponseEntity<ErrorMessage>{
        return buildReponse(servletRequest,
            ex.javaClass.simpleName,
    ...
    fun notFoundExceptionHandler(servletRequest: HttpServletRequest,
                                 servletResponse: HttpServletResponse,
                                 ex: NotFoundException): ResponseEntity<ErrorMessage>{
        return buildReponse(servletRequest,
            ex.javaClass.simpleName,
            ex.message !!,
    ...
    fun nullPointerExceptionHandler(servletRequest:HttpServletRequest,
                                             servletResponse: HttpServletResponse,
                                             ex: NullPointerException):ResponseEntity<ErrorMessage>{
        return buildReponse(servletRequest,
            ex.javaClass.simpleName,
    ...
    fun illegalArgumentExceptionHandler(servletRequest:HttpServletRequest,
                                        servletResponse: HttpServletResponse,
                                        ex: IllegalArgumentException):ResponseEntity<ErrorMessage>{
        return buildReponse(servletRequest,
            ex.javaClass.simpleName,
    ...
    fun methodArgumentNotValidExceptionHandler(servletRequest:HttpServletRequest,
                                               servletResponse: HttpServletResponse,
                                               ex: MethodArgumentNotValidException):ResponseEntity<ErrorMessage>{
